...
data_dir = 'C:/Users/linda/OneDrive/Desktop/datasettest'  # Replace with the path to your dataset
test_dataset = datasets.ImageFolder(data_dir, transform=test_transforms)
test_loader = DataLoader(test_dataset, batch_size=32, shuffle=False, num_workers=4)

# Load the pre-trained VGG16 model and the trained weights
model_path = 'C:/Users/linda/OneDrive/Desktop/cnn/model_epoch_15.pth'  # Replace with the path to your saved model weights
model = models.vgg16(pretrained=False)
model.classifier[6] = nn.Linear(model.classifier[6].in_features,
                                2)  # Assuming binary classification (Drowsy and NonDrowsy)
